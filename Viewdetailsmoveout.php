                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <select name="column_name" id="column_name" class="form-control selectpicker" multiple>
                                ...
                                <option value="16">Bedspace Number</option>
                                <option value="17">Contract End Date</option>
                                <option value="18">Move out End</option>
                                <option value="19">Document Count </option>
                                <option value="20">Gatepass</option>
                                <option value="21">RC - Move out Signed</option>
                                <option value="22">SOA - Signed</option>
                                <option value="23">Renewal Notice</option>
                                <option value="24">Compliant</option>
                                <option value="25">Non-Compliant</option>
                                <option value="26">Grade</option>
                                </select>

                            <form method="post" action="dataexportmoveout.php" align="center">  
                    ...
                    <div class="table-responsive">
                        <table id="sample_data" class="table table-bordered table-striped">
                            <thead>
                                ...
                                <th>Move Out End</th>
                                <th>Document Count (5)</th>
                                <th>Gatepass - Completely Signed</th>
                                <th>RC - Move Out Signed</th>
                                <th>SOA - Signed</th>
...
$(document).ready(function(){
 ...
 function fetch_data(is_date_search, start_date='', end_date='')
 {
  var dataTable = $('#sample_data').DataTable({
   ...
   "order" : [],
   "ajax" : {
    url:"vdetailsdatefiltermoveout.php",
    type:"POST",
    data:{
...
<script src="vdetailsdatefiltermoveout.php"></script>
