<?php session_start(); ?>
<?php include('db/db_login.php'); ?>
<html>
<head>
<meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>K RESIDENCES</title>
    <meta name="csrf-param" content="_csrf">
<meta name="csrf-token" content="Hi10wMctI6w52sn7F7krfYRAbSy-57kwJk4BptKbVJBpbjiEglcS3HeI-r9wwEUf3jUeS9zR82RwfHvn5Pg7_A==">
...
.btn-primary { 
    ...
    background-image: 
    -moz-linear-gradient(top, #6eb6de, #4a77d4); 
...
<body>
  ...
  ?>
  <center><p><a href="#" onClick = "checkbox()">Forgot password?</a></p></center>
    </div>
...
<footer class ="footer">
<div class ="container"/>
        <p class="pull-left">&copy; Sweetchoice Marketing Corpration 2021</p>
</div>
</footer>
...
<script type = "text/javascript">
    function checkbox() {
        ...
        var confirmmessage = "CONTACT IT (+639356454542) (+639555638428)"
