...
.topnav a:hover {
  ...
  color: black;
        ...
        <div id="layoutSidenav">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="401.html">Movein Scorecard</a>
            ...
            <form class="form-horizontal well" action="backendmoveout.php" method="post" name="upload_excel" enctype="multipart/form-data">
            <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="control-group">
                <div class="controls">
                <button type="submit" id="submit" name="Importmo" class="btn btn-primary button-loading" data-loading-text="Loading...">Upload</button>
                </div>
                </div>
            </fieldset>
            </form>
        ...
        <?php
        $SQLSELECT = "SELECT * FROM subjectmoveout ";
        ...
        ?>
                                ...
                                <td><?php echo $row['SECTION_COL']; ?></td>
                                ...
                                <td><?php echo $row['CT_END']; ?></td>
                                <td><?php echo $row['MO_END']; ?></td>
                                <td><?php echo $row['DOC_COUNT']; ?></td>
                                <td><?php echo $row['GATEPASS']; ?></td>
                                <td><?php echo $row['RC_MO']; ?></td>
                                <td><?php echo $row['SOA_SIGN']; ?></td>
                                <td><?php echo $row['REN_NOTI']; ?></td>
