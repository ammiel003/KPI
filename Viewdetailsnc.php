                    ...
                    <div class="row">  
                        ...
                        <div class="col-lg-3">
                            <select name="column_name" id="column_name" class="form-control selectpicker" multiple>
                                ...
                                <option value="16">DOCUMENT COUNT</option>
                                <option value="17">Contract Signed - All Pages</option>
                                <option value="18">House Rules Signed - All Pages</option>
                                <option value="19">Authorized (Not on rejected list)</option>
                                <option value="20">Tenant Name - Accurate</option>
                                <option value="21">Bedspace Number - Accurate</option>
                                <option value="22">Guardian's Info - Accurate</option>
                                </select>

                        <form method="post" action="dataexportnc.php" align="center">  
                        ...
                        <table id="sample_data" class="table table-bordered table-striped">
                            <thead>
                               ...
                               <tr>
                                ...
                                <th>Contract Signed - All Pages</th>
                                <th>House Rules Signed - All Pages</th>
                                <th>Authorized (Not on rejected list)</th>
                                <th>Tenant Name - Accurate</th>
                                <th>Bedspace Number - Accurate</th>
                                <th>Guardian's Info - Accurate</th>
                                <th>Compliant</th>
                                <th>Non-Compliant</th>
                                <th>Grade</th>
                                </tr>
...
<script src="vdetailsdatefilternc.php"></script>
